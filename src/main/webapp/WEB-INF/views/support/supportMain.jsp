...
#supportListOne > thead > tr >th{
	color : white;
	border : 0px;
}

#supportListTwo > thead > tr >th{
	color : white;
	border : 0px;
}
.updateClinic{
  ...
  <!--  <div class="move_share1">
   ...
   <form id="enrollForm" action="psComplete.me" method="post">
      <div class="patientInfo" style="width:100%;">
         <div style="background:rgb(1,153,220);padding-top:10px; height:35px;text-align:center;font-size: 17px; color:white;">
            <!-- <p style="">환자정보</p> -->
            	환자정보
         </div>
         <div class="infoOne">
            ...
            <tbody>
               ...
               <c:forEach items="${ list1 }" var="s">
                  <tr>
                     ...
                     <td style="display:none">${ s.actionYN }</td>
                  </tr>
               </c:forEach>
            </tbody>   
         </table>
